...
export const getCalendarTableArray = (year, month0) => {
    ...
    const totalCalendarDays = Math.ceil((startWeekDay + currentMonthDays) / WEEK_COUNT) * WEEK_COUNT;
    const calendar = Array(totalCalendarDays)
        .fill(null)
        .map((_, index) => {
